...
function preload(){
      ...
      fruit2Img=loadImage("fruits/grapes.png")
       tigerRunning=loadAnimation("tiger/sprite_0.png","tiger/sprite_1.png","tiger/sprite_2.png","tiger/sprite_3.png")
...
if(mousePressedOver(restart)){
  ...
  text ("strength"+strength,200,400)
}
function tiger(){
  if(frameCount % 160 ===0){
